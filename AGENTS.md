...
src/licenseal/
  ...
  resolvers/
    ...
    deps_dev.py               api.deps.dev v3alpha batch + v3 stable single-version (per-ecosystem bulk wrappers for Python/npm/Rust/Go/NuGet/Java/Ruby license resolution; Maven :dependencies endpoint for Java transitive resolution — note: deps.dev's GetDependencies is documented for npm/Cargo/Maven/PyPI only, NOT Go/NuGet/RubyGems)
